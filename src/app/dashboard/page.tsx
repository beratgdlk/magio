...
export default function DashboardPage() {
  ...
  const [activeCard, setActiveCard] = useState<'balance' | 'spending' | 'saved'>('balance');
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button 
                    className="text-sm text-[#29A073] font-medium hover:underline cursor-pointer transition-colors"
              ...
              <div>
                <div className="flex items-center justify-between mb-4 relative">
                  ...
                  <div className="relative">
                    <button 
                      className="text-2xl text-gray-400 hover:text-gray-600 cursor-pointer transition-colors p-2 hover:bg-gray-100 rounded-lg"
